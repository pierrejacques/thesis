...
\end{table}
网格复杂度的推测力与其他图像特征相比不算很显著。但其纵向网格数量和纵向均衡性方差分别都对美感表现出了显著的负相关推测力。一方面这表明网页的行向排版（通过纵向特征统计）比列向排版（通过横向特征统计）对美感更有推测力。一方面表明美感评分好的网页往往具有更均衡的有序的网格排版。
...
表\ref{tab:blank}的结果表明，“大中小”三种占空的面积对美感都有显著的推测能力。而“大”和“中”表现出正相关，“小”表现出负相关意味着画面的留白在不同内容区块之间较大同事在同类区块之间较小的时候网页页面版式会比较好看。这与类间间距越大，类内间距越小则越美观的观点是一致的，其实代表着一种信息的有序性。
...
结果表明总体而言信息密度相关的特征与美感评分有显著的相关性。局部上，特定区域的信息量对美感评分的推测力尤为显著，意味着人们在眼动习惯上虽然有各自不同的习惯，但是对画面上特定位置（左上，中部，左侧）都表现出了较为一致的关注。这可能与现代人的文字阅读习惯有关，也许在具有不同阅读方向习惯的文化环境（如阿拉伯）中，这些关注点会有所不同。
...
视觉显著性相关的特征在四类特征中表现出了最强的美感推测力。结果表明对于每个区块自身而言，区块内部的显著性方差越小，越有可能取得更高的美感评分；而整体而言，显著性重心的适度倾斜对美感评分有积极的贡献。
